            ...
            <form method="POST" action="{{ route('register.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0-1.657 1.343-3 3-3s3 1.343 3 3v1h1a2 2 0 012 2v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5a2 2 0 012-2h1v-1c0-1.657 1.343-3 3-3s3 1.343 3 3v1h0z"></path>
                            </svg>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-600 mt-1 ml-7">
                                Activate bonus payments for implemented innovations
                            </p>
                        </div>
                ...
                <div class="text-center pt-4 border-t border-gray-200">
                    <p class="text-xs text-gray-500 space-y-1">
                        ...
                        <span class="block">✅ Cancel anytime</span>
                    </p>
                </div>
            </form>
        </div>
