...
class ProjectsOverview extends StatsOverviewWidget
{
    protected function getStats(): array
    {
        ...
        // Urgent Expiry (less than 5 days remaining)
        ...
        return [
            Stat::make('Total Projects', $totalProjects)
                ->description('All registered companies/projects')
                ->color('primary')
            ...
            Stat::make('Urgent Expiry', $urgentExpiryCount)
                ->description('Trials expiring in < 5 days')
                ->color('danger')
